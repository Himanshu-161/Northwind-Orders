...
public class OrderService {
    ...
    private void updateProductStock(Integer ProductId , Integer Unit){
        ...
        String url = "http://localhost:8082/updateProduct?ProductId=<ProductId>&Unit=<Unit>"
                .replace("<ProductId>",String.valueOf(ProductId))
                .replace("<Unit>",String.valueOf(Unit));

        ResponseEntity <Void> responseEntity = restTemplate.exchange(url, HttpMethod.PUT,entity, Void.class,map);
